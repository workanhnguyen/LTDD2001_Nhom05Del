...
CREATE TABLE `category_root` (
  ...
  `image` longtext COLLATE utf8mb4_vietnamese_ci,
  `type` enum('INCOME','EXPENSE') COLLATE utf8mb4_vietnamese_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `transaction` (
  ...
  CONSTRAINT `fk_transaction_wallet` FOREIGN KEY (`wallet_id`) REFERENCES `wallet` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `user` (
  `id` int NOT NULL AUTO_INCREMENT,
  `firstname` varchar(45) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `lastname` varchar(45) COLLATE utf8mb4_vietnamese_ci NOT NULL,
...
-- Dump completed on 2023-06-28 18:01:30
